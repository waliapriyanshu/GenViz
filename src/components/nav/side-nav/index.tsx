  ...
  return (
    <>
      ...
      >
        ...
        <div className="mt-auto p-4 text-xs text-center text-slate-500 dark:text-slate-400 border-t border-border/50">
          <p className="font-medium mb-1">Created with ❤️ by Priyanshu</p>
          <p className="opacity-75 text-[10px] italic">More updates coming soon...</p>
        </div>
      </aside>
    </>
  );
